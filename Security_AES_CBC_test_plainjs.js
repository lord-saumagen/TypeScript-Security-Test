...
(function (TS_Security_test)
{
  ...
  let AES_CBC_TestVector128;
  let AES_CBC_TestVector192;
  let AES_CBC_TestVector256;
  let numberArray16;
  ...
  QUnit.test("AES_CBC constructor (plain js)", function (assert)
  {
    ...
    // TypeError: Class constructor AES_CBC cannot be invoked without 'new'
  ...
  QUnit.test("AES_CBC_Stream constructor (plain js)", function (assert)
  {
    ...
    // TypeError: Class constructor AES_CBC_Stream cannot be invoked without 'new'

    assert.throws(function ()
    {
      aes_CBC_Stream = new TS.Security.AES_CBC_Stream({}, unsignedByteValueArray16, TS.Security.CipherOperationEnum.ENCRYPT, onNextData, onClodes, onError);
    }, TS.InvalidTypeException, "Should throw a 'TS.InvalidTypeException' for a call with an invalid value for the 'keyByteArray' argument.");
    ...
    assert.throws(function ()
    {
      aes_CBC_Stream = new TS.Security.AES_CBC_Stream(unsignedByteValueArray16, unsignedByteValueArray16,{}, onNextData, onClodes, onError);
    ...
    assert.throws(function ()
    {
      aes_CBC_Stream = new TS.Security.AES_CBC_Stream(unsignedByteValueArray16, unsignedByteValueArray16, TS.Security.CipherOperationEnum.ENCRYPT, "test", onClodes, onError);
    ...
    assert.throws(function ()
    {
      aes_CBC_Stream = new TS.Security.AES_CBC_Stream(unsignedByteValueArray16, unsignedByteValueArray16, TS.Security.CipherOperationEnum.ENCRYPT, onNextData, "test", onError);
    ...
    assert.throws(function ()
    {
      aes_CBC_Stream = new TS.Security.AES_CBC_Stream(unsignedByteValueArray16, unsignedByteValueArray16, TS.Security.CipherOperationEnum.ENCRYPT, onNextData, onClodes, "test");
