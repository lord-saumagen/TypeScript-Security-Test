...
(function (TS_Security_test) {
  let AES_OFB_TestVector128;
  let AES_OFB_TestVector192;
  let AES_OFB_TestVector256;
  let numberArray16;
  ...
  QUnit.test("AES_OFB constructor (plain js)", function (assert)
  {
    ...
    // TypeError: Class constructor AES_OFB cannot be invoked without 'new'
  ...
  QUnit.test("AES_OFB_Stream constructor (plain js)", function (assert)
  {
    ...
    // TypeError: Class constructor AES_OFB_Stream cannot be invoked without 'new'
    ...
    assert.throws(function ()
    {
      aes_OFB_Stream = new TS.Security.AES_OFB_Stream(unsignedByteValueArray16, unsignedByteValueArray16, {}, onNextData, onClosed, onError);
    ...
    assert.throws(function ()
    {
      aes_OFB_Stream = new TS.Security.AES_OFB_Stream(unsignedByteValueArray16, unsignedByteValueArray16, TS.Security.CipherOperationEnum.ENCRYPT, "test", onClosed, onError);
    ...
    assert.throws(function ()
    {
      aes_OFB_Stream = new TS.Security.AES_OFB_Stream(unsignedByteValueArray16, unsignedByteValueArray16, TS.Security.CipherOperationEnum.ENCRYPT, onNextData, "test", onError);
    ...
    assert.throws(function ()
    {
      aes_OFB_Stream = new TS.Security.AES_OFB_Stream(unsignedByteValueArray16, unsignedByteValueArray16, TS.Security.CipherOperationEnum.ENCRYPT, onNextData, onClosed, "test");
