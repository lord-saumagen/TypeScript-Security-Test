...
(function (TS_Security_test) {
  let AES_CFB_TestVector128_1BIT;
  let AES_CFB_TestVector192_1BIT;
  let AES_CFB_TestVector256_1BIT;
  let AES_CFB_TestVector128_8BIT;
  let AES_CFB_TestVector192_8BIT;
  let AES_CFB_TestVector256_8BIT;
  let numberArray16;
  ...
  QUnit.test("AES_CFB constructor (plain js)", function (assert)
  {
    ...
    // TypeError: Class constructor AES_CFB cannot be invoked without 'new'
    ...
    {
      aes_CFB = new TS.Security.AES_CFB(unsignedByteValueArray16, {}, 8);
    }, TS.InvalidTypeException, "Should throw a 'TS.InvalidTypeException' for a call with an invalid value for the 'initialisationVector' argument.");

    assert.throws(function ()
    {
      aes_CFB = new TS.Security.AES_CFB(unsignedByteValueArray16, unsignedByteValueArray16, "test");
    }, TS.InvalidTypeException, "Should throw a 'TS.InvalidTypeException' for a call with an invalid value for the 'segmentSizeInBit' argument.");
  ...
  QUnit.test("AES_CFB_Stream constructor (plain js)", function (assert)
  {
    ...
    assert.throws(function ()
    {
      aes_CFB_Stream = new TS.Security.AES_CFB_Stream(unsignedByteValueArray16, unsignedByteValueArray16, "test" , TS.Security.CipherOperationEnum.ENCRYPT, onNextData, onClosed, onError);
    }, TS.InvalidTypeException, "Should throw a 'TS.InvalidTypeException' for a call with an invalid value for the 'segmentSizeInBit' argument.");

    assert.throws(function ()
    {
      aes_CFB_Stream = new TS.Security.AES_CFB_Stream(unsignedByteValueArray16, unsignedByteValueArray16, 8, {}, onNextData, onClosed, onError);
    ...
    assert.throws(function ()
    {
      aes_CFB_Stream = new TS.Security.AES_CFB_Stream(unsignedByteValueArray16, unsignedByteValueArray16, 8, TS.Security.CipherOperationEnum.ENCRYPT, "test", onClosed, onError);
    ...
    assert.throws(function ()
    {
      aes_CFB_Stream = new TS.Security.AES_CFB_Stream(unsignedByteValueArray16, unsignedByteValueArray16, 8, TS.Security.CipherOperationEnum.ENCRYPT, onNextData, "test", onError);
    ...
    assert.throws(function ()
    {
      aes_CFB_Stream = new TS.Security.AES_CFB_Stream(unsignedByteValueArray16, unsignedByteValueArray16, 8, TS.Security.CipherOperationEnum.ENCRYPT, onNextData, onClosed, "test");
